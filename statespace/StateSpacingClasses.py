...
from .StateSpacingKalman import KalmanV1, KalmanRust_V1
...
class LinearGaussianModel_v2_numpy:
    ...
    kalman: KalmanProtocol = KalmanV1()
    plotting: PlottingProtocol = Plotting_Matplotlib()
    ...
    def plot_states(self, signal_components=None, state_only=False):
        ...
        self.plotting.plot_states(filter_map, signal_components, state_only, a, att, a_hat, y, T, Z)
    ...
    def plot_state(self, state_name: str, filter_type='smoothed'):
        ...
        self.plotting.plot_state(state_name, a, att, a_hat, P, Ptt, P_hat, y, T, Z, filter_map, filter_type=filter_type)

@dataclass
class LinearGaussianModel_v3_rust:
    ...
    kalman: KalmanProtocol = KalmanRust_V1()
    plotting: PlottingProtocol = Plotting_Matplotlib()
